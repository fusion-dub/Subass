...
const PayloadSchema = z.object({
    ...
    dubber_specialization: z.string().optional(),
    dubber_archetypes: z.string().optional(),
    dubber_voice: z.string().optional(),
    dubber_timbre: z.string().optional(),
    dubber_vocals: z.string().optional(),
    dubber_status: z.string().optional(),
    dubber_languages: z.string().optional(),
    ...
    try {
        ...
        const { error: upsertError } = await supabaseAdmin
            ...
            .upsert({
                ...
                dubber_specialization: userData.dubber_specialization,
                dubber_archetypes: userData.dubber_archetypes,
                dubber_voice: userData.dubber_voice,
                dubber_timbre: userData.dubber_timbre,
                dubber_vocals: userData.dubber_vocals,
                dubber_status: userData.dubber_status,
                dubber_languages: userData.dubber_languages,
                os: userData.os,
